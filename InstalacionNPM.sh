...
# Esto era para usar boostrap pero lo saque 
#npm install bootstrap #-- Instala Boostrap para el estilo \
#npm i @popperjs/core #-- Interactua con boostrap para la parte de menus desplegables 
#probar  https://fontawesome.com/v5.15/how-to-use/on-the-web/setup/using-package-managers